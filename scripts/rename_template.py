...
It renames all the occurrences of alr_isaaclab_tasks (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the alr_isaaclab_tasks folder
        os.rename(
            os.path.join(root_dir_path, "exts", "alr_isaaclab_tasks", "alr_isaaclab_tasks"),
            os.path.join(root_dir_path, "exts", "alr_isaaclab_tasks", new_name),
        )
        os.rename(
            os.path.join(root_dir_path, "exts", "alr_isaaclab_tasks"), os.path.join(root_dir_path, "exts", new_name)
        )
