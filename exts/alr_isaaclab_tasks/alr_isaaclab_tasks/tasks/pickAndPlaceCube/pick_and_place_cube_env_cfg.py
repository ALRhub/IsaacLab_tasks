...
from alr_isaaclab_tasks.tasks.pickAndPlaceCube.mdp.commands.pose_command_min_dist_cfg import (
    UniformPoseWithMinDistCommandCfg,
)
from alr_isaaclab_tasks.tasks.pickAndPlaceCube import mdp
...
class DenseRewardCfg:
    ...
    object_ee_distance = RewTerm(
        func=mdp.object_ee_distance, weight=-1.0 / (ENV_DT * 2)
    )
...
@configclass
class PickAndPlaceCubeEnvCfg(ManagerBasedRLEnvCfg):
