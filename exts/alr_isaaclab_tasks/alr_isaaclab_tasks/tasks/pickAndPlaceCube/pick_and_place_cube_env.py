...
from exts.alr_isaaclab_tasks.alr_isaaclab_tasks.tasks.pickAndPlaceCube.pick_and_place_cube_env_cfg import PickAndPlaceCubeEnvCfg
...
class PickAndPlaceCubeEnv(ManagerBasedRLEnv):

    def __init__(self, cfg: PickAndPlaceCubeEnvCfg, render_mode: str | None = None, **kwargs):
