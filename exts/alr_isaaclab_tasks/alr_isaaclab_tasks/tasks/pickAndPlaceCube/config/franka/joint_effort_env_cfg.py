...
from exts.alr_isaaclab_tasks.alr_isaaclab_tasks.tasks.pickAndPlaceCube.pick_and_place_cube_env_cfg import (
    BoxPushingEnvCfg,
    DenseRewardCfg,
...
from alr_isaaclab_tasks.tasks.pickAndPlaceCube.assets.franka import (
